...
/**
 * Servlet implementation class a_Person
 */
@WebServlet("/a_Person")
public class a_Person extends HttpServlet {
		...
		// TODO Auto-generated method stub
			...
			private void updatepwd(HttpServletRequest request, HttpServletResponse response) throws IOException {
				...
				if(result)
				{
		            ...
		            out.println("<script>window.location.href='/OASystem/average/pwd_update.jsp'</script>");
		        }
				else 
				{
			...
			private void findinfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
				...
				PrintWriter   out   =   response.getWriter(); 
				out.println("<script>window.location.href='/OASystem/average/person.jsp'</script>");
			}
