...
/**
 * Servlet implementation class a_File
 */
@WebServlet("/a_File")
public class a_File extends HttpServlet {
	...
	private void showemployee(HttpServletRequest request, HttpServletResponse response) throws IOException {
		a_FileIF ms = a_Factory.getFileInstance();
		...
		response.sendRedirect("average/file_upload.jsp");
	}
	...
	private void file_send(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		PrintWriter   out   =   response.getWriter(); 
		out.println("<script>window.location.href='/OASystem/average/file_send.jsp'</script>");
	}
	...
	private void file_receive(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		PrintWriter   out   =   response.getWriter(); 
		out.println("<script>window.location.href='/OASystem/average/file_receive.jsp'</script>");
	}
