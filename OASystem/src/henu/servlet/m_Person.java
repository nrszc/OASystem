...
/**
 * Servlet implementation class m_Person
 */
@WebServlet("/m_Person")
public class m_Person extends HttpServlet {
		...
		// TODO Auto-generated method stub
			...
			private void updatepwd(HttpServletRequest request, HttpServletResponse response) throws IOException {
				...
				if(result)
				{
		            ...
		            out.println("<script>window.location.href='/OASystem/middle/pwd_update.jsp'</script>");
		        }
				else 
				{
			...
			private void findinfo(HttpServletRequest request, HttpServletResponse response) throws IOException {
				...
				PrintWriter   out   =   response.getWriter(); 
				out.println("<script>window.location.href='/OASystem/middle/person.jsp'</script>");
			}
