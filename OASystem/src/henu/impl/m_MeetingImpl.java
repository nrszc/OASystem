...
public class m_MeetingImpl implements m_MeetingIF{

	@Override
	public List<Meeting> m_meeting(String employeeID) throws ParseException {
	...
	@Override
	public List<Meeting> m_release(String employeeID) throws ParseException {
		// TODO Auto-generated method stub
		String sql = null;
  		sql = "SELECT * "
