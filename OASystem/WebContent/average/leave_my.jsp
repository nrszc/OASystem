...
<div class="wrapper">
  ...
  <ul class="nav nav-tabs ">
        <li role="presentation" class="active"><a href="../a_Leave?method=leave_my">我的请假</a></li>
 ...
 <section class="content-header">
	...
	<table class="table table-hover table-bordered" style="table-layout:fixed;" id="table">
		...
		<tr>
		    <td><a href="../a_Leave?method=leave_detail&leaveID=${item.leaveID }">${item.leaveText }</a></td>
		    <td>${item.toName }</td>
