...
<div class="wrapper">
  ...
  <div class="content-wrapper"><br><br><br><br>
  <div class="row">
  ...
  <div class="box">
        <div class="box-header with-border">
				...
				<p>
					OA办公系统就是采用Internet/Intranet技术，基于工作流概念，使企业内部人员方便快捷地共享信息，高效协同工作；改变过去复杂、低效的手工办公方式，实现迅速、全方位的信息采集、处理，为企业管理和决策提供科学依据。企业实现办公自动化程度也是衡量其实现现代化管理的标准。办公自动化不仅兼顾个人办公效率提高，更重要的是可实现群体协同工作。凭借网络，这种交流与协调几乎可以在瞬间完成。这里所说的群体工作，可以包括在地理上分布很广，甚至在全球上各个地方，以至于工作时间都不一样的一群工作人员。网络考试解决方案。它基于JAVA与MYSQL开发，可以稳定、顺畅的运行在Windows与Linux平台上。您可以通过它快捷方便的创建题库，发布试卷，组织考试，并由系统自动批改。高度的可配置性和灵活性使得它可以被应用于很多领域。
					<br>Enjoy it!
				</p>
...
将公司日常行政管理、业务审批流程，全部电子化、实现无纸化，通过移动审批进一步提高内部效率。			</p>
			<p>
