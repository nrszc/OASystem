...
<body class="hold-transition skin-blue sidebar-mini" data-spy="scroll"
	...
	<div class="wrapper">
		<header class="main-header">
			...
			<!-- Logo -->
			<a href="averageHome.jsp" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		...
		<div class="content-wrapper">
			...
			<ul class="nav nav-tabs ">
				<li role="presentation"><a
					href="../a_File?method=file_receive">接收文件</a></li>
				<li role="presentation"><a href="../a_File?method=file_send">我发送的</a></li>
				<li role="presentation" class="active"><a
					href="../a_File?method=showemployee">发送文件</a></li>
			</ul>
			...
			<section class="content">
				...
				<div class="box box-default">
					...
					<div class="box-body">
						<div class="row">
							<form action="../a_File?method=uploadfile" method="post"
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>文件类型</label> <select class="form-control"
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>接受人(公司、部门)</label> <select class="form-control"
											id="test">
											<option>请先选择文件类型</option>
										</select> <select class="form-control" name="companyfile"
											id="companyfile">
											<option value="company">全公司</option>
										</select> <select class="form-control" name="deptfile" id="deptfile">
										</select> <a data-toggle="modal" data-target="#myModal" id="t88888">
											<input type="text" id="tags" class="form-control tags" />
										</a> <input type="text" id="fruitChecked" name="sendTo" />
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<c:forEach items="${sessionScope.list1}" var="item"
						varStatus="status">
						<input type="checkbox" value="${item.employeeName }" name="fruit"
							onclick="radioHandle(this.value, '${item.employeeID}')" />${item.employeeName }(${item.deptName }${item.jobName } ) 
				 </c:forEach>
				</div>
