...
<div class="wrapper">
 ...
 <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs">
        <li role="presentation"><a href="../a_Task?method=myTask">我的任务</a></li>
      </ul>
    <!-- Content Header (Page header) -->
   ...
   <section class="content">
    ...
    <c:if test="${sessionScope.task_detail.taskState!='完成任务'&&sessionScope.task_detail.taskState!='任务过期未完成'}">
     <a href="../a_Task?method=handle&taskID=${sessionScope.task_detail.taskID }&taskState=${sessionScope.task_detail.taskState}">${sessionScope.task_detail.state}</a>
     </c:if>
      </div>   
     </div>
   </div>
