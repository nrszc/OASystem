...
<ul class="nav nav-tabs ">
        <li role="presentation"><a href="../a_Mail?method=mail_receivebox">收信箱</a></li>
        <li role="presentation" class="active"><a href="../a_Mail?method=mail_sendbox">已发送</a></li>
 ...
 <section class="content-header">
    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <c:choose>
          <c:when test="${sessionScope.send==null || fn:length(sessionScope.send) == 0}">  
          <center>  
          <strong>还没有人给您发送邮件！</strong>  
          </center>  
          </c:when>  
          <c:otherwise>
          <form action="../a_Mail?method=deletesend" method="post">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <button type="button" class="btn btn-default btn-sm"><a href="../a_Mail?method=mail_sendbox" ><i class="fa fa-refresh"></i></a></button>
               ...
               <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped " style='table-layout:fixed;'>
                  <tbody>
                  <c:forEach items="${sessionScope.send}" var="item" varStatus="status">  
                  <tr>
                    <td style="width:5%;"><input type="checkbox" name="sendID" value="${item.sendID }" ></td>
                    <td style="width:25%;" class="mailbox-name" ><a href="../a_Mail?method=mail_senddetail&sendID=${item.sendID }">${item.sendTitle }</a></td>
                    <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;width:45%;" class="mailbox-subject">
                    ${item.sendText }
                    </td>
                    <td class="mailbox-attachment" style="width:10%;">${item.toName }</td>
                    <td class="mailbox-date" style="width:15%;">${item.sendDate }</td>
                  </tr>
                  </c:forEach>
                  </tbody>
                  </table>
