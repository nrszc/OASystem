...
<div class="wrapper">
 ...
 <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="../a_Meeting?method=myMeeting">我参与的</a></li>
      </ul>
    <!-- Content Header (Page header) -->
   ...
   <section class="content">
	...
	<table class="table table-hover table-bordered" id="table">
		...
		<tr>
		    <td><a href="../a_Meeting?method=meeting_detail&meetingID=${item.meetingID }">${item.meetingName}</a></td>
