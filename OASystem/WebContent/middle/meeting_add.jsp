...
<div class="wrapper">
 ...
 <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active" ><a href="../m_Meeting?method=employee">新增会议</a></li>
      </ul>
    <!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">请会议信息</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
          
          <form method="post" action="../m_Meeting?method=addmeeting">
		    <div class="col-md-12">
             ...
             <div class="col-md-12">
              <div class="form-group">
                <label >会议描述</label>
                <input class="form-control" type="text" name="meetingText" />
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <label >开始时间</label>
                <input readonly class="form-control form_datetime" type="text" name="startTime"  />
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                <label >结束时间</label>
                <input readonly class="form-control form_datetime" type="text" name="endTime"  />
              </div>
            </div>
             ...
             <div class="col-md-12">
              <div class="form-group">
               ...
               <input type="hidden" id="fruitChecked"  name="employeeId">   
              </div>
             </div>
            ...
            <div class="box-footer">
              <div class="pull-left">
                <button type="submit" class="btn btn-primary">发布会议</button>
              </div>
            </div>
