...
<div class="wrapper">
  ...
  <!-- Content Wrapper. Contains page content -->
   <div class="content-wrapper">
    ...
    <form action="../m_Activity?method=activity_result&activeID=${sessionScope.activity.activeID}" method="post">
            ...
            <div class="box-body no-padding">
              <table class="table table-condensed">
                ...
                <tr>
                  ...
                  <td><input type="radio" name="choose" value="0"></td>
                </tr>
                <tr>
                  <td>2.</td>
                  <td>低调反对</td>
                  ...
                  <td><input type="radio" name="choose" value="1"></td>
                </tr>
                <tr>
                  <td>3.</td>
                  <td>绝对中立</td>
                  ...
                  <td><input type="radio" name="choose" value="2"></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
