  ...
  <!-- Content Wrapper. Contains page content -->
   <div class="content-wrapper">
    <ul class="nav nav-tabs ">
        <li role="presentation"><a href="../m_Activity?method=myactivity">我发起的</a></li>
        <li role="presentation"><a href="../m_Activity?method=activity_part">我参与的</a></li>
        <li role="presentation"><a href="../m_Activity?method=activity_unpart">未参与的</a></li>
      </ul>
    ...
    <div class="pad margin no-print">
      <div class="callout callout-info" style="margin-bottom: 0!important;">
        <h4><i class="fa fa-info"></i> 注意:</h4>
                 不管三七二十一，投票支持好了。投票是个人的神圣义务。真理不是靠喝采造出来的，是靠投票决定的。
        </div>
    </div>
       ...
       <div class="col-xs-12">
           <div class="box">
            <div class="box-header">
              <h3 class="box-title">
                             发起人：${sessionScope.activity.employeeName}&#12288;
                             发起时间：${sessionScope.activity.createTime}&#12288;
                             主题：${sessionScope.activity.activeName}
              </h3><p>
              <h3 class="box-title" >${sessionScope.activity.activeInfo}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table class="table table-condensed">
                <tr>
                  ...
                  <th>选项</th>
                  <th>投票情况</th>
                  <th style="width: 120px">参与${sessionScope.activity.sum}</th>
                </tr>
                <tr>
                  <td>1.</td>
                  <td>双手赞成
                  <c:if test="${sessionScope.activity.choose==0}">
                  (已选)
                  </c:if>
                  </td>
                  <td>
                    <div class="progress progress-xs">
                      <div class="progress-bar progress-bar-green" style="width: ${sessionScope.activity.agreePercent}"></div>
                    </div>
                  </td>
                  <td><span class="badge bg-green">${sessionScope.activity.activeAgreeNum}人&#12288;${sessionScope.activity.agreePercent}</span></td>
                </tr>
                <tr>
                  <td>2.</td>
                  <td>低调反对
                  <c:if test="${sessionScope.activity.choose==1}">
                  (已选)
                  </c:if>
                  </td>
                  <td>
                    <div class="progress progress-xs">
                      <div class="progress-bar progress-bar-red" style="width:${sessionScope.activity.disagreePercent}"></div>
                    </div>
                  </td>
                  <td><span class="badge bg-red">${sessionScope.activity.activeDisagreeNum}人&#12288;${sessionScope.activity.disagreePercent}</span></td>
                </tr>
                <tr>
                  <td>3.</td>
                  <td>绝对中立
                  <c:if test="${sessionScope.activity.choose==2}">
                  (已选)
                  </c:if>
                  </td>
                  <td>
                    <div class="progress progress-xs progress-striped active">
                      <div class="progress-bar progress-bar-primary" style="width: ${sessionScope.activity.othersPercent}"></div>
                    </div>
                  </td>
                  <td><span class="badge bg-light-blue">${sessionScope.activity.activeOthersNum}人&#12288;${sessionScope.activity.othersPercent}</span></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
