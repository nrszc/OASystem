...
<div class="wrapper">
 ...
 <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs">
        <li role="presentation" class="active"><a href="../s_Meeting?method=myMeeting">我参与的</a></li>
   ...
   <section class="content">
      <!-- Info boxes -->
       ...
       <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
        <c:choose>
    <c:when test="${sessionScope.myMeeting==null || fn:length(sessionScope.myMeeting) == 0}">  
    <center>  
	...
	<table class="table table-hover table-bordered" id="table">
		...
		<tbody>
		<c:forEach items="${sessionScope.myMeeting}" var="item" varStatus="status">  
		<tr>
