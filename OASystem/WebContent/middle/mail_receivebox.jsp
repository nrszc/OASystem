...
<ul class="nav nav-tabs ">
        <li role="presentation" class="active"><a href="../m_Mail?method=mail_receivebox">收信箱</a></li>
  ...
  <section class="content">
    <div class="row">
        <div class="col-md-12">
          ...
          <c:otherwise>
          <form action="../m_Mail?method=deletereceive" method="post">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <button type="button" class="btn btn-default btn-sm"><a href="../m_Mail?method=mail_receivebox" ><i class="fa fa-refresh"></i></a></button>
                </div>
                <!-- /.pull-right -->
              </div>
               <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped " style='table-layout:fixed;'>
                  ...
                  <tr>
                    ...
                    <td style="width:20%;" class="mailbox-name" ><a href="../m_Mail?method=mail_receivedetail&receiveID=${item.receiveID }">${item.receiveTitle }</a></td>
