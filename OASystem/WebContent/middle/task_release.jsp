...
<div class="wrapper">
 ...
 <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="../m_Task?method=myReleaseTask">我发起的</a></li>
   ...
   <section class="content">
	...
	<table class="table table-hover table-bordered" id="table">
		...
		<tr>
		    <td><a href="../m_Task?method=task_detail&taskID=${item.taskID }">${item.taskName}</td>
		    <td>${item.taskInfo}</td>		     
		    <td>${item.taskTime }</td>
		    ...
		    <td>
		    <a href="../m_Task?method=deletetask&taskID=${item.taskID }">删除</a>
		    </td>
	    </tr>
	    </c:forEach>
   	    </tbody>
