          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="../m_Colleague?deptID=${item.deptID}&method=searchbydept"><i class="fa fa-tags"></i> ${item.deptName }</a></li>
                </c:forEach>
                </c:otherwise>
                </c:choose>
              </ul>
              ...
              <div class="table-responsive mailbox-messages">
                ...
                <thead>
                 ...
                 <th>QQ</th>
                  ...
                  <tr>
                    <td><a href="../m_Colleague?method=find_detail&employeeID=${item.employeeID }">${item.employeeName }</a></td>
                    <td>${item.sex }</td>
                    <td>${item.deptName }</td>
                    <td>${item.jobName }</td>
                    <td>${item.phone }</td>
