    ...
    <!-- /.sidebar -->
		...
		<div class="content-wrapper">
			...
			<ul class="nav nav-tabs ">
				...
				<li role="presentation"><a href="../m_File?method=file_send">我发送的</a></li>
				<li role="presentation" class="active"><a
					href="../m_File?method=showemployee">发送文件</a></li>
			</ul>
			...
			<section class="content">
				...
				<div class="box box-default">
					...
					<div class="box-body">
						<div class="row">
							<form action="../m_File?method=uploadfile" method="post"
