...
<div class="wrapper">
  ...
  <ul class="nav nav-tabs ">
        <li role="presentation" ><a href="../m_Note?method=allnote">全部公告</a></li>
        <li role="presentation" class="active"><a href="../m_Note?method=mynote">我发布的</a></li>
    ...
    <c:choose>
    <c:when test="${sessionScope.note==null || fn:length(sessionScope.note) == 0}">  
    <center>  
    <strong>还没有公告哦</strong>  
    </center>  
    </c:when>  
    <c:otherwise>
    <c:forEach items="${sessionScope.note}" var="item" varStatus="status">  
      <!-- Default box -->
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="../m_Note?method=note_detail&noteID=${item.noteID }">${item.noteName }</a></h3>

          <div class="box-tools pull-right">
            <span class="time"><i class="fa fa-clock-o"></i> ${item.noteTime }</span>
          </div>
        </div>
        <div class="box-body">
        ${item.noteInfo }
        ...
        <div class="box-footer">
          发布人：${item.employeeName }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  范围：${item.deptName }
        </div>
        <div class="box-footer">
        <a href="../m_Note?method=deletenote&noteID=${item.noteID }"><button class="btn btn-primary">删除公告</button></a>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
