...
<ul class="nav nav-tabs ">
        ...
        <li role="presentation" class="active"><a href="../m_Mail?method=mail_sendbox">已发送</a></li>
 ...
 <section class="content-header">
    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <c:otherwise>
          <form action="../m_Mail?method=deletesend" method="post">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-controls">
                ...
                <!-- /.btn-group -->
                <button type="button" class="btn btn-default btn-sm"><a href="../m_Mail?method=mail_sendbox" ><i class="fa fa-refresh"></i></a></button>
               ...
               <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped " style='table-layout:fixed;'>
                  ...
                  <tr>
                    ...
                    <td style="width:25%;" class="mailbox-name" ><a href="../m_Mail?method=mail_senddetail&sendID=${item.sendID }">${item.sendTitle }</a></td>
