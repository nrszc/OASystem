  ...
  <div class="content-wrapper">
    ...
    <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs ">
        <li role="presentation" class="active"><a href="../m_Activity?method=myactivity">我发起的</a></li>
    ...
    <section class="content">
      ...
      <div class="col-md-9">
          ...
          <div class="box">
            ...
            <form action="../m_Activity?method=deleteactivity&activeID=${item.activeID}" method="post">
   ...
   <div class="modal fade" id="addactivity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	   <div class="modal-dialog">
		   <div class="modal-content">
			   ...
			   <form method="post" action="../m_Activity?method=addactivity">
			   <div class="modal-body">
				     ...
				     面向部门（公司）：${sessionScope.em.deptName }
			   </div>
