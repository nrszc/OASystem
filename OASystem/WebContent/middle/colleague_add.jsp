...
<body class="hold-transition skin-blue sidebar-mini" onload="changeDept()">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
          <form action="../m_Colleague?method=addemployee" method="post">
          <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>所属部门</label>
                <select name="deptID" id="deptID1" class="form-control select2" style="width: 100%;">
...
<script>  
    ...
    function changeDept() { 
        ...
        $.ajax({  
            type : "post",  
            url : "../m_Colleague?method=selectJob",  
            dataType : "text",  
