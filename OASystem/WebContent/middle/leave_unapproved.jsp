...
<div class="wrapper">
  ...
  <ul class="nav nav-tabs ">
        ...
        <li role="presentation" class="active"><a href="../m_Leave?method=leave_unapproved">未审批的</a></li>
      ...
      <!-- Info boxes -->
       ...
       <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
    <c:choose>
    <c:when test="${sessionScope.leave==null || fn:length(sessionScope.leave) == 0}">  
    <center>  
    <strong>还没有要审批的请假哦！</strong>  
    </center>  
    </c:when>  
    <c:otherwise>
	<table class="table table-hover table-bordered" style="table-layout:fixed;" id="table">
		<thead>
			<tr>
			<th>请假事由</th>
            <th>请假人</th>
		...
		<tbody>
		<c:forEach items="${sessionScope.leave}" var="item" varStatus="status">  
		<tr>
		    <td><a href="../m_Leave?method=leave_detail1&leaveID=${item.leaveID }">${item.leaveText }</a></td>
		    <td>${item.fromName }</td>
