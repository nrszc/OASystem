         ...
         <div class="row">
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <button type="button" class="btn btn-default"><a href="../m_Mail?method=deletereceive&receiveID=${sessionScope.receive.receiveID}" ><i class="fa fa-trash-o"></i>删除</a> </button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
