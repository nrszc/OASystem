...
<div class="wrapper">
  ...
  <ul class="nav nav-tabs ">
        ...
        <li role="presentation" class="active"><a href="../s_Leave?method=leave_unapproved">未审批的</a></li>
 </ul>
 ...
 <section class="content-header">
	...
	<table class="table table-hover table-bordered" style="table-layout:fixed;" id="table">
		...
		<tr>
		    <td><a href="../s_Leave?method=leave_detail1&leaveID=${item.leaveID }">${item.leaveText }</a></td>
		    <td>${item.fromName }</td>
