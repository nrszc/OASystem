...
<ul class="nav nav-tabs ">
        ...
        <li role="presentation" class="active"><a href="../s_Mail?method=addemployee">新发邮件</a></li>
 </ul>
 ...
 <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">新发邮件</li>
      </ol>
    </section>
 
  <section class="content">
  <form action="../s_Mail?method=mail_send" method="post">
    <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">发送新邮件</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="hidden" id="fruitChecked" name="sendTo" />  
              </div>
              <div class="form-group">
                                  主题
