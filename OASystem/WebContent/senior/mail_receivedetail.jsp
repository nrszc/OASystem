          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <div class="mailbox-read-info">
                <h3>${sessionScope.receive.receiveTitle}</h3>
                <h5>发件人: ${sessionScope.receive.fromName}
                  <span class="mailbox-read-time pull-right">${sessionScope.receive.receiveDate}</span></h5>
              </div>
              <!-- /.mailbox-controls -->
              <div class="mailbox-read-message">
                ${sessionScope.receive.receiveText}
              </div>
            ...
            <div class="box-footer">
              <button type="button" class="btn btn-default"><a href="../s_Mail?method=deletereceive&receiveID=${sessionScope.receive.receiveID}" ><i class="fa fa-trash-o"></i>删除</a> </button>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /. box -->
