...
<!-- Content Wrapper. Contains page content -->
  ...
  <ul class="nav nav-tabs ">
        ...
        <li role="presentation" class="active"><a href="../s_Note?method=mynote">我发布的</a></li>
    ...
    <c:forEach items="${sessionScope.note}" var="item" varStatus="status">  
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><a href="../s_Note?method=note_detail&noteID=${item.noteID }">${item.noteName }</a></h3>
        ...
        <div class="box-footer">
        <a href="../s_Note?method=deletenote&noteID=${item.noteID }"><button class="btn btn-primary">删除公告</button></a>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
