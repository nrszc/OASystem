...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <ul class="nav nav-tabs ">
        <li role="presentation"><a href="../s_Leave?method=leave">已审批的</a></li>
        <li role="presentation"><a href="../s_Leave?method=leave_unapproved">未审批的</a></li>
 </ul>
                       ...
                       <div class="panel">
                        <div class="panel-body">
                            <h1 class="text-center cmnt-head">审批人:${sessionScope.leave.toName} </h1>
                             <form action="../s_Leave?method=approve&leaveID=${sessionScope.leave.leaveID}" method="post">
                                <p class="fade-txt">
