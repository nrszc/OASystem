...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <ul class="nav nav-tabs ">
        <li role="presentation" class="active"><a href="../s_File?method=file_receive">接收文件</a></li>
        <li role="presentation" ><a href="../s_File?method=file_send">我发送的</a></li>
        <li role="presentation"><a href="../s_File?method=showemployee">发送文件</a></li>
    </ul>
...
<section class="content">
      <!-- Info boxes -->
       ...
       <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
        <c:choose>
    <c:when test="${sessionScope.mf==null || fn:length(sessionScope.mf) == 0}">  
    <center>  
	...
	<table class="table table-hover table-bordered" id="table">
		...
		<tbody>
		<c:forEach items="${sessionScope.mf}" var="item" varStatus="status">  
		<tr>
		    <td>${item.fileName }</td>
		    <td>${item.fileText }</td>
		    <td>${item.fileTime }</td>
		    <td>${item.fileType }</td>
		    <td>${item.fileFrom }</td>
		    <td><a href="../s_File?method=download&fileName=${item.fileName }">下载文件</a></td>
	    </tr>
	    </c:forEach>
   	    </tbody>
    </table>
