...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
	...
	<div class="form-group onAllDay">
	    ...
	    <div class="col-sm-10">
	    	<input name="startTime" readonly value="" type="text" class="Wdate form-control validate[required,maxSize[60]] form_datetime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd'})" id="form-validation-field-0">
	    </div>
	  </div>
	<div class="form-group onAllDay">
	    <label class="col-sm-2 control-label">结束时间:</label>
	    <div class="col-sm-10">
	    	<input name="endTime" value="" readonly type="text" class="Wdate form-control validate[required,maxSize[60]] form_datetime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd'})" id="form-validation-field-0">
	  ...
	  <div class="form-group unAllDay" style="display:none;">
	    <label class="col-sm-2 control-label">开始时间:</label>
	    <div class="col-sm-10">
	    	<input name="startTime" value="" readonly type="text" class="Wdate form-control validate[required,maxSize[60]] form_datetime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm'})" id="form-validation-field-0">
	    </div>
	  </div>
	<div class="form-group unAllDay" style="display:none;">
	    <label class="col-sm-2 control-label">结束时间:</label>
	    <div class="col-sm-10">
	    	<input name="endTime" value="" readonly type="text" class="Wdate form-control validate[required,maxSize[60]] form_datetime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm'})" id="form-validation-field-0">
	    	<span style="color:red;">如果是当天的日程，结束时间可以不填！</span>
	    </div>
	  </div>
	  <div class="form-group">
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updatefLabel" aria-hidden="true">
	...
	<div class="form-group onAllDay">
	    <label class="col-sm-2 control-label">开始时间:</label>
	    <div class="col-sm-10">
	    	<input name="startTime" value="" readonly type="text" class="Wdate form-control validate[required,maxSize[60]] form_datetime" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd'})" id="form-validation-field-0">
	    </div>
	  </div>
	<div class="form-group onAllDay">
	    <label class="col-sm-2 control-label">结束时间:</label>
