...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <ul class="nav nav-tabs ">
        ...
        <li role="presentation" class="active"><a href="../s_File?method=file_send">我发送的</a></li>
...
<section class="content">
      <!-- Info boxes -->
       ...
       <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
        <c:choose>
    <c:when test="${sessionScope.mft==null || fn:length(sessionScope.mft) == 0}">  
    <center>  
	...
	<table class="table table-hover table-bordered" id="table">
		...
		<tbody>
		<c:forEach items="${sessionScope.mft}" var="item" varStatus="status">  
		<tr>
		    <td>${item.fileName }</td>
		    <td>${item.fileText }</td>
		    <td>${item.fileTime }</td>
