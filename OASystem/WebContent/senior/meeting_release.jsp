...
<div class="wrapper">
 ...
 <!-- Content Header (Page header) -->
      <ul class="nav nav-tabs">
        ...
        <li role="presentation" class="active"><a href="../s_Meeting?method=myRelease">我发起的</a></li>
   ...
   <section class="content">
	...
	<table class="table table-hover table-bordered" id="table">
		...
		<tr>
		    <td><a href="../s_Meeting?method=meeting_detail&meetingID=${item.meetingID }">${item.meetingName}</a></td>
		    ...
		    <span class="label label-default">${item.condition}</span>
		     ...
		     <td>
		     <a href="../s_Meeting?method=meeting_delete&meetingID=${item.meetingID }">删除</a>
		     </td>	
	    </tr>
	    </c:forEach>
   	    </tbody>
